...
```{r load-datasets, cache = TRUE, include = FALSE}

sys.source("src/Make raw/Make Raw.R", envir = knitr::knit_global())
sys.source("src/Make td/Make td.R", envir = knitr::knit_global())
sys.source("src/Make ad/Make ad.R", envir = knitr::knit_global())
```


# Introduction
This is the report for the first Data Monitoring Committee meeting in the NOR-SOLIDARITY trial. The data are based on an export from the Viedoc electronic data capture system time stamped 28 April 2020 13:49 UTC. There were `r n_distinct(adsl)` included patients.
