...
dm_table <- tribble(
  ...
  "Obese, n(%)", "n_pct", "vsobese", list(level="Obese"),
  ...
  "Oxygen requirement (Litres O~2~ per min)", "mean_sd", "lito2min", list(digits = 1),
  "No information on oxygen (litres O~2~ per min)", "n_pct", "lito2min_reg", list(level = "No")
)


dm_table_f <- function(data, caption, header){
dm_table %>%
...
dm_table_f(addm_tot, "Demographics, all arms (FAS)", header_tot)

dm_table_f(addm_hcq, "Demographics, HCQ (FAS)", header_hcq)

dm_table_f(addm_rem, "Demographics, Remdesivir (FAS)", header_rem)
